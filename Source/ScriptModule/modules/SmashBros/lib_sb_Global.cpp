...
namespace SmashBros
{
	chaiscript::ModulePtr load_module_SmashBros_Global()
	{
        ...
        m_smashbros_global->add_global_const(chaiscript::const_var(SmashBros::Global::CHAR_DANTE), "CHAR_DANTE");
        m_smashbros_global->add_global_const(chaiscript::const_var(SmashBros::Global::CHAR_SAMUS), "CHAR_SAMUS");
        m_smashbros_global->add_global_const(chaiscript::const_var(SmashBros::Global::CHAR_CHARIZARD), "CHAR_CHARIZARD");
