...
namespace SmashBros
{
	...
	void TitleScreen::LoadContent()
	{
		...
		titleScreen->setScale(2.5f);
	}//sets the title screen size
	...
	{//left-right,up-down
		addItem(740, 430, "Images/Menus/Buttons/Group/group.png", "Images/Menus/Buttons/Group/group_selected.png", "GroupMenu");
		setItemScale(0,2);
		setItemSound(0, Menus::soundMgr->getSound("select menu item"));
        
		addItem(1535, 500, "Images/Menus/Buttons/Solo/solo.png", "Images/Menus/Buttons/Solo/solo_selected.png", "SoloMenu");
		setItemScale(1,2);
		setItemSound(1, Menus::soundMgr->getSound("select menu item"));
        
		addItem(2660, 920, "Images/Menus/Buttons/Options/options.png", "Images/Menus/Buttons/Options/options_selected.png", "OptionsMenu");
		setItemScale(2,5);
		//setItemSound(2, Menus::soundMgr->getSound("select menu item"));
		//if(GameEngine::isOnPlatform("ios"))
        
        addItem(1535, 670, "Images/Menus/Buttons/Bluetooth/Bluetooth.png", "Images/Menus/Buttons/Bluetooth/Bluetooth_selected.png", "BluetoothMenu");
        setItemScale(3,2);
        setItemSound(3, Menus::soundMgr->getSound("select menu item"));
        {
            
            //addItem(2500, 1000, "Images/Menus/Buttons/Bluetooth/Bluetooth.png", "Images/Menus/Buttons/Bluetooth/Bluetooth_selected.png", "BluetoothMenu");
           // setItemScale(2,4);
           // setItemSound(3, Menus::soundMgr->getSound("select menu item"));
	...
	{
		addItem(500, 900, "Images/Menus/Buttons/Group/brawl.png", "Images/Menus/Buttons/Group/brawl_selected.png", "BrawlCharSelect");
		setItemSound(0, Menus::soundMgr->getSound("select menu item"));
	...
	void DisplayOptions::Initialize()
	{
		...
		fps = new MenuBarValue(800, 600/*200*/, "Frame Rate");
