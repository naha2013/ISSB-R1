...
namespace SmashBros
{
	...
	{
		Game::setLoadBar(0, 1280, 2778, 12, Color::BLUE);
        ...
        BatchLoader::addImage("Images/Menus/CharacterSelect/icons/charizard.png");
        
		BatchLoader::addImage("Images/Menus/CharacterSelect/icons/samus.png");
        ...
        BatchLoader::addImage("Images/Menus/CharacterSelect/previews/samus.png");
        BatchLoader::addImage("Images/Menus/CharacterSelect/previews/charizard.png");
	...
	void Menus::loadMenus()
	{
		...
		button_back = new BackButton(2670,1100);
		//back button
